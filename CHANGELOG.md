...
- Preferred `pastime.statcast.search_pitches(...)` and
  `pastime.mlb.search_player_matches(...)` aliases for consistent public API
  naming.

### Changed

- Expanded the README's Statcast and MLB Stats API endpoint overview.
- Updated package metadata to match the GitHub About description.
